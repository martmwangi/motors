...
<div id="pagecontent" align="center">
  ...
  <form enctype="multipart/form-data" action="store_uploader.php" method="POST">
    ...
    <fieldset>
        ...
        <table align="center">
            ...
            <tr>
                <td>Seller:</td>
                <td><input type="text" name ="seller" id="name" />
            ...
            <tr>
                <td>Contact:</td>
                <td><input type="text" name ="contact" id="price" /></td>
            </tr>
