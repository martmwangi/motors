...
<div id="pagecontent" align="justify">
  <p>KENYA MOTORS</p>
  <div id="wb_Text124" style="width:148px;height:14px;z-index:128" align="left">
      <div style="height:270px;width:1100px;position: absolute;top: 200px;font:16px/26px Helvetica;overflow:auto;">                   
...
while ($row = mysql_fetch_array($result)) {
    ...
    echo '
      ...
      <td style="padding-left:100px;"><img src="uploads/'.$image.'" width="119" height="118" alt="'.$image.'" /></td>
